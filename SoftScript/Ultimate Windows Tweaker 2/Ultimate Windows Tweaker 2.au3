...
$DirToDecompress = 'Ultimate Windows Tweaker 2'
...
; EndIf
ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\UWT v2.2\Ultimate Windows Tweaker.exe','',@ScriptDir&'\'&$DirToDecompress&'\UWT v2.2')
Func FindCompressor()
