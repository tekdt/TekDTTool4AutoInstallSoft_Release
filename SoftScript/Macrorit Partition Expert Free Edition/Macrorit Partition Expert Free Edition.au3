...
$DirToDecompress = 'Macrorit Partition Expert Free Edition'
...
; Tạo shortcut
If @OSArch = 'X86' Then
	ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\mde-free-portable\x86\dm.exe','',@ScriptDir&'\'&$DirToDecompress&'\mde-free-portable\x86')
ElseIf @OSArch = 'X64' Then
	ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\mde-free-portable\x64\dm.exe','',@ScriptDir&'\'&$DirToDecompress&'\mde-free-portable\x64')
EndIf
