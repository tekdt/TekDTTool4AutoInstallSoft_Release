...
$DirToDecompress = 'Firewall App Blocker'
...
; Tao shortcut
If @OSArch = 'X86' Then
	ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\fab\Fab.exe','',@ScriptDir&'\'&$DirToDecompress&'\fab')
ElseIf @OSArch = 'X64' Then
	ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\fab\Fab_x64.exe','',@ScriptDir&'\'&$DirToDecompress&'\fab')
EndIf
