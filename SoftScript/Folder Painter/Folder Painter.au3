...
$DirToDecompress = 'Folder Painter'
...
; Tao shortcut
If @OSArch = 'X86' Then
	ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\FolderPainter\FolderPainter.exe','',@ScriptDir&'\'&$DirToDecompress&'\FolderPainter')
ElseIf @OSArch = 'X64' Then
	ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\FolderPainter\FolderPainter_X64.exe','',@ScriptDir&'\'&$DirToDecompress&'\FolderPainter')
EndIf
