...
$DirToDecompress = 'Ultimate Windows Tweaker 5'
...
; EndIf
ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\UWT 5.1\Ultimate Windows Tweaker 5.1.exe','',@ScriptDir&'\'&$DirToDecompress&'\UWT 5.1')
Func FindCompressor()
