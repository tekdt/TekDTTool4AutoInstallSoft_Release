...
$DirToDecompress = 'EaseUS Partition Master - Free'
...
; ElseIf @OSArch = 'X64' Then
	; FileCreateShortcut(@HomeDrive&'\'&$DirToDecompress&'\IDM-Activation-Script-main\IAS.cmd',$ShortcutPath,@HomeDrive&'\'&$DirToDecompress)
; EndIf
ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\portableTrial\bin\EPMStarter.exe','',@ScriptDir&'\'&$DirToDecompress&'\portableTrial\bin')
