...
; Tao shortcut
If @OSArch = 'X86' Then
	ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\DnsAngel\DnsAngel.exe','',@ScriptDir&'\'&$DirToDecompress&'\DnsAngel')
ElseIf @OSArch = 'X64' Then
	ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\DnsAngel\DnsAngel_x64.exe','',@ScriptDir&'\'&$DirToDecompress&'\DnsAngel')
EndIf
