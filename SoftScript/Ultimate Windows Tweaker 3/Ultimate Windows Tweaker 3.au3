...
$DirToDecompress = 'Ultimate Windows Tweaker 3'
...
; EndIf
ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\Ultimate Windows Tweaker 3.1.2.0\Ultimate Windows Tweaker 3.exe','',@ScriptDir&'\'&$DirToDecompress&'\Ultimate Windows Tweaker 3.1.2.0')
Func FindCompressor()
