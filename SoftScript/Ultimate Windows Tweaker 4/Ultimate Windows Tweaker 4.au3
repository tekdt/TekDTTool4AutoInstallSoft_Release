...
$DirToDecompress = 'Ultimate Windows Tweaker 4'
...
; EndIf
ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\Ultimate Windows Tweaker 4.8\Ultimate Windows Tweaker 4.8.exe','',@ScriptDir&'\'&$DirToDecompress&'\Ultimate Windows Tweaker 4.8')
Func FindCompressor()
