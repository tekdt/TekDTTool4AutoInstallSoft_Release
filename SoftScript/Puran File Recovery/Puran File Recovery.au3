...
$DirToDecompress = 'Puran File Recovery'
...
; ElseIf @OSArch = 'X64' Then
	; FileCreateShortcut(@HomeDrive&'\'&$DirToDecompress&'\IDM-Activation-Script-main\IAS.cmd',$ShortcutPath,@HomeDrive&'\'&$DirToDecompress)
; EndIf
ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\Puran File Recovery\X86\Puran File Recovery.exe','',@ScriptDir&'\'&$DirToDecompress&'\Puran File Recovery\X86')
