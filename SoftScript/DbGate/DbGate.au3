...
$DirToDecompress = 'DbGate'
$InstallDir = @ProgramFilesDir&'\'&$DirToDecompress
...
; EndIf
FileCreateShortcut(@ProgramFilesDir&'\'&$DirToDecompress&'\DbGate.exe',$ShortcutPath,@ProgramFilesDir&'\'&$DirToDecompress)
