...
$DirToDecompress = 'MiniTool Partition Wizard Free'
...
; ElseIf @OSArch = 'X64' Then
	; FileCreateShortcut(@HomeDrive&'\'&$DirToDecompress&'\IDM-Activation-Script-main\IAS.cmd',$ShortcutPath,@HomeDrive&'\'&$DirToDecompress)
; EndIf
ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\pwfree-32bit-portable\partitionwizard.exe','',@ScriptDir&'\'&$DirToDecompress&'\pwfree-32bit-portable')
