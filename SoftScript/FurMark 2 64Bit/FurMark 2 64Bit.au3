...
; EndIf
ShellExecute(@ScriptDir&'\'&$DirToDecompress&'\FurMark_win64\FurMark_GUI.exe','',@ScriptDir&'\'&$DirToDecompress&'\FurMark_win64')
Func FindCompressor()
